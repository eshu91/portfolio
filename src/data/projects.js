...
export const projects = [
  ...
  { id: 'interview-coach', title: 'Chromium Engine Extension', blurb: 'Chrome extension powered by the Anthropic API.', tech: ['Chrome Extension', 'Anthropic API'], github: '', demo: '', featured: true, category: 'ai', ai: true, locked: false },
