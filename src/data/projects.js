...
export const projects = [
  {
    ...
    blurb: "Full-stack services marketplace web application.",
  ...
  },
  {
    ...
    blurb: "React Three Fiber, custom GLSL shaders, scroll-driven camera.",
    tech: ["React", "R3F", "GLSL", "GSAP"],
    github: "https://github.com/eshu91",
    demo: "",
    featured: true,
    category: "3d",
    ai: false,
  ...
  {
    id: "ppt-tooling",
    title: "PPT Generation Tooling",
    blurb: "Automated slide generation pipeline.",
  ...
  },
  {
    ...
    blurb: "Personal Google Apps Script dashboard.",
  ...
  {
    id: "camera-game",
    title: "Browser Camera Game",
    blurb: "Hand/gesture game with MediaPipe Tasks Vision.",
    tech: ["MediaPipe", "JavaScript"],
    github: "",
    demo: "",
    featured: true,
    category: "ai",
  ...
  },
  {
    ...
    title: "e-Doko",
    blurb:
      "E-commerce app for the Nepali community, built @ Quality IT Solutions.",
  ...
  {
    id: "sheets-suite",
    title: "Sheets Automation Suite",
    blurb:
      "Student Management System · Expense Tracker · Study Progress Tracker.",
  ...
  },
  {
    ...
    blurb: "Windows Server, AD, DNS/DHCP, Exchange, Cisco routing, VoIP.",
    tech: ["Windows Server", "Cisco", "VoIP"],
    github: "",
    demo: "",
    featured: false,
    category: "infra",
  ...
  },
  {
    ...
    blurb: "Full-Stack Build in Progress",
    tech: [],
    github: "",
    demo: "",
    featured: false,
  ...
  {
    id: "locked-2",
    title: "🤖 AI PROJECT - Classified",
    blurb: "Launching soon",
    tech: [],
    github: "",
    demo: "",
    featured: false,
  ...
  },
  {
    id: "locked-3",
    title: "🛰️ INCOMING TRANSMISSION",
    blurb: "Signal acquired… decoding",
    tech: [],
    github: "",
    demo: "",
    featured: false,
