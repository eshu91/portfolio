...
If you're changing *what* the site says (a project, a skill, a milestone, a link),
you only touch a data file. If you're changing *how* it looks or moves
...
Hero *sizing* (title/button scale on the landing view) is in
...
*relative weights* (the whole timeline is scrubbed across total page scroll).
